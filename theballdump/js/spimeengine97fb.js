	...
	$(document).ready(function() {
		...
		if (shopId){
			if (typeof sraddtocheckout == "undefined"){
				$.getScript( "../space.shoprocket.co/frontend/v8/sr.js", function( data, textStatus, jqxhr ) {});
			}
...
SpimeEngine.getProductUrl = function(pid){
	...
	if (isInnerpage){
		if (pathName.indexOf("free/index.html") != -1 || pathName.indexOf("viewer/index.html") != -1 || pathName.indexOf("live/index.html") != -1){
